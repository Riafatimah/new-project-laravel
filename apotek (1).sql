...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2022 at 08:06 AM
...
--
ALTER TABLE `pembeli`
  MODIFY `Kode_Pembeli` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `obat`
  ...
  ADD CONSTRAINT `obat_ibfk_3` FOREIGN KEY (`Kode_Pembeli`) REFERENCES `pembeli` (`Kode_Pembeli`);
